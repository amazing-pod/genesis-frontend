...
const IdeationFeature = ({ closeModal }) => {
	...
	useEffect(() => {
		setIdeaList(ideas.map((idea) => idea.title));
	}, []);
	...
	const addStep = () => {
		...
		if (ideaList || projectDescription.trim() !== "") {
			...
			setError(
				"Please select an idea from the dropdown or enter a project description."
			);
		}
	};
				...
				return (
					<>
						<div className="ideation-feature-user-info">
							...
							<hr />
							<p>
								To generate project features, complete either of the following
								options:
							</p>
						...
						<img
							className="generate-features-image"
							src={generate_features_image}
							alt="generate features image"
						/>
					</>
				);
				...
				return (
					<>
						<div className="ideation-project-user-info">
							...
							<p>
								Based on your previous project description, tell us any features
								you intend on implementing:
							</p>
				...
				return (
					<>
						<div className="ideation-project-results">
							...
							<div className="project-ideation-button-container">
								<button className="generate" onClick={closeModal}>
									Finish
								</button>
