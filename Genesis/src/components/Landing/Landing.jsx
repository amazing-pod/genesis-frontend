		...
		<>
			...
			<div className="landing-page-container">
				...
				<div className="landing-item-container">
					<div className="landing-info">
						<h2 className="landing-header">
							...
							<span className="emphasis-text">Reality</span>
						</h2>
						<p>
				...
				<div className="landing-item-container">
					<div className="landing-info">
						<h2 className="landing-header">
							We’ll take <span className="emphasis-text">you</span> to the
							finish line
						</h2>
						<p>
				...
				<div className="landing-item-container">
					<div className="landing-info">
						<h2 className="landing-header">
							...
							<span className="emphasis-text">potential</span>
						</h2>
						<p>
				...
				<div className="landing-item-container">
					<div className="landing-info">
						<h2 className="landing-header">
							Find your <span className="emphasis-text">community</span>
						</h2>
						<p>
